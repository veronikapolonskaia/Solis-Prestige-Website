    ...
    try {
      ...
      if (hotel) {
        setFormData({
          ...
          specialOffer: hotel.specialOffer || false,
          offerTitle: hotel.offerTitle || '',
          offerDetails: hotel.offerDetails || '',
          offerValidUntil: hotel.offerValidUntil ? hotel.offerValidUntil.split('T')[0] : '',
          offerBookingDeadline: hotel.offerBookingDeadline ? hotel.offerBookingDeadline.split('T')[0] : '',
          offerBlackoutDates: hotel.offerBlackoutDates || [],
          price: hotel.price || '',
          currency: hotel.currency || 'USD',
          vipBenefits: hotel.vipBenefits || [],
...
useEffect(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const message = error?.response?.data?.error || error?.response?.data?.message || 'Failed to update hotel';
      toast.error(message);
    } finally {
      setSaving(false);
    }
